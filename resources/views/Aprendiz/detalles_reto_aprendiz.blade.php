<div id="vermas">
		<div id="contenido_reto" class="contenido"> 
			...
			<div id="areatexto">
				<textarea  readonly="readonly" name="comentarios" rows="5" cols="50">{{$resultado->descripcion_proye }}</textarea>
		</div>

		<div class="boton_aplicar1">
			<div id="btn_aplicar">
				<button type="submit" id="postular_reto" name="{{ $resultado->id }}" class="btn success uno">
				Aplicar </button>
			</div>
			<div id="btn_cancelar">					
